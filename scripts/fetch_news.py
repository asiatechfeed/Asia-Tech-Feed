#!/usr/bin/env python3
"""
Asia Tech News Feed Ã¢ÂÂ Daily Scraper
...
# Domains that are inherently Asia-focused — no SE Asia term required
...
# Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
# NEWS SOURCES Ã¢ÂÂ (name, type, url, rss_url or scrape config)
# Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
def normalize_date(raw_date) -> datetime | None:
    """Parse various date formats Ã¢ÂÂ timezone-aware UTC datetime."""
    if not raw_date:
        return None
    try:
...
def fetch_url(url: str, timeout: int = 15) -> requests.Response | None:
    try:
        ...
        print(f"  Ã¢ÂÂ  Failed to fetch {url}: {e}")
        return None
...
def fetch_rss(source: dict) -> list[dict]:
    ...
    try:
        ...
        print(f"  Ã¢ÂÂ  RSS parse error for {rss_url}: {e}")
        return []


def fetch_scrape(source: dict) -> list[dict]:
    """HTML scrape fallback."""
    print(f"  Ã°ÂÂÂ Scraping: {source['url']}")
...
def summarize_with_claude(articles: list[dict]) -> list[dict]:
    ...
    if not ANTHROPIC_API_KEY:
        print("Ã¢ÂÂ  ANTHROPIC_API_KEY not set Ã¢ÂÂ using raw summaries.")
        for a in articles:
    ...
    for idx, article in enumerate(articles):
        print(f"  Ã°ÂÂ¤Â Summarizing {idx+1}/{len(articles)}: {article['title'][:60]}...")
...
{{
  ...
  "key_point_1": "<First key takeaway Ã¢ÂÂ factual, journalist style, unique angle, 1-2 sentences>",
  "key_point_2": "<Second key takeaway Ã¢ÂÂ factual, journalist style, unique angle, 1-2 sentences>",
  "key_point_3": "<Third key takeaway Ã¢ÂÂ factual, journalist style, unique angle, 1-2 sentences>",
  "tags": ["<tag1>", "<tag2>", "<tag3>"]
}}
...
def render_news_table(articles: list[dict]) -> str:
    ...
    for i, a in enumerate(articles, 1):
        ...
        kp = a.get("key_points", ["", "", ""])
        date_str = a["date"].strftime("%d %b %Y") if a.get("date") else "Ã¢ÂÂ"
        url = a["url"]
...
def write_jekyll_post(articles: list[dict], run_date: datetime) -> Path:
    ...
    front_matter = f"""---
layout: post
title: "Asia Tech News Digest Ã¢ÂÂ {run_date.strftime('%B %d, %Y')}"
...
"""
    ...
    print(f"Ã¢ÂÂ Jekyll post written: {filename}")
    return filename
...
<tr style="border-bottom:1px solid #eee;">
  ...
  <td style="padding:10px 8px;">
    ...
    <div style="font-size:11px;color:#888;">Ã¢ÂÂ¢ {kp[0]}<br>Ã¢ÂÂ¢ {kp[1]}<br>Ã¢ÂÂ¢ {kp[2]}</div>
    <div style="margin-top:6px;">
      ...
      <a href="{a['url']}" style="font-size:11px;color:#e84545;margin-left:10px;">Read Ã¢ÂÂ</a>
    </div>
  </td>
</tr>"""
...
<body style="font-family:Segoe UI,sans-serif;max-width:800px;margin:0 auto;padding:20px;color:#2d3748;">
  <div style="background:#1a3a5c;color:#fff;padding:20px 24px;border-radius:8px 8px 0 0;">
    <h2 style="margin:0;font-size:1.2rem;">Ã¢ÂÂ¡ Asia Tech News Digest Ã¢ÂÂ {run_date.strftime('%B %d, %Y')}</h2>
    <p style="margin:6px 0 0;font-size:13px;color:rgba(255,255,255,0.7);">{len(articles)} articles ÃÂ· Filtered for SE Asia + tech keywords ÃÂ· Awaiting your approval</p>
  </div>
  <div style="background:#fff5e6;border:1px solid #f6ad55;border-radius:0 0 8px 8px;padding:14px 20px;margin-bottom:20px;">
    <strong>Ã°ÂÂÂ Action required:</strong> Review the {len(articles)} articles below.
  ...
  <div style="margin-top:20px;padding:14px;background:#f7fafc;border-radius:6px;font-size:12px;color:#718096;text-align:center;">
    Auto-generated by Asia Tech News Feed ÃÂ· GitHub Actions
  </div>
</body>
</html>"""
...
def main():
    ...
    print(f"\nÃ°ÂÂÂ Asia Tech News Feed Ã¢ÂÂ {run_date.strftime('%Y-%m-%d %H:%M SGT')}")
    print("=" * 60)

    all_articles = []

    for source in SOURCES:
        print(f"\nÃ°ÂÂÂ° [{source['short']}] {source['name']}")
        try:
            if source.get("rss") or source["type"] == "rss":
                raw = fetch_rss(source)
            else:
                raw = fetch_scrape(source)
            print(f"  Ã¢ÂÂ {len(raw)} items fetched")
        except Exception as e:
    ...
    print(f"\nÃ°ÂÂÂ {len(all_articles)} relevant articles found before dedup")
    all_articles = deduplicate(all_articles)
    print(f"Ã°ÂÂÂ {len(all_articles)} after deduplication")
    ...
    print(f"Ã°ÂÂÂ Top {len(all_articles)} selected")

    if not all_articles:
        print("\nÃ¢ÂÂ  No articles matched. Exiting without creating post.")
    ...
    print(f"\nÃ¢ÂÂ Done! {len(all_articles)} articles Ã¢ÂÂ {post_path.name}")
    print(f"Ã°ÂÂÂ§ Email preview: {email_path}")
