...
<tr>
  ...
  <td class="col-points"><ul class="key-points">
    <li>Singaporebased semiconductor</li>
    <li>semiconductor packaging</li>
    <li>packaging company</li>
  </ul></td>
...
<tr>
  ...
  <td class="col-points"><ul class="key-points">
    <li>Collaboration creates</li>
    <li>creates simulationready</li>
    <li>simulationready semiconductor</li>
  </ul></td>
...
<tr>
  ...
  <td class="col-points"><ul class="key-points">
    <li>Longsys introduced</li>
    <li>introduced edge</li>
    <li>edge</li>
  </ul></td>
  <td class="col-tags"><span class="tag "> ai </span></td>
